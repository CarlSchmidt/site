...
\begin{itemize} \itemsep -2pt
	\item Rozenn Robidel (PhD expected 2023, Université Paris-Saclay) \textit{Study of the exosphere of Mercury with the PHEBUS spectrograph on the BepiColombo mission}%LATMOS Laboratoire Atmosphères, Milieux, Observations Spatiales
\end{itemize}

\noindent Faculty Search Committee Memberships:
\begin{itemize} \itemsep -2pt
	\item Boston University, Space Physics, 2023
\end{itemize}
...
\rule{\textwidth}{1pt}
\begin{itemize} \itemsep -2pt % reduce space between item
  \item D. Bhattacharyya, J. T. Clarke, M. Mayyasi, V. Shematovich, D. Bisikalo, J. Y. Chaufray, E. Thiemann, J. Halekas, C. Schmidt, J. L. Bertaux, M. S. Chaffin, and N. M. Schneider (2023) \textit{Evidence of Hot Hydrogen in the Exosphere of Mars Resulting in Enhanced Water Loss}. Journal of Geophysical Research: Planets, \textit{in press}
  \item \underline{P. Lierle}, C. Schmidt, J. Baumgardner, L. Moore and \underline{E. Lovett} (2023) \textit{The Rapid Imaging Planetary Spectrograph}. Publications of the Astronomical Society of the Pacific, \textit{in press}, \href{https://arxiv.org/abs/2307.16872}{arXiv pre-print.}
...
\rule{\textwidth}{1pt}
 \begin{itemize} \itemsep -2pt % reduce space between items
   \item \underline{Lovett, E.}, Schmidt, C., \underline{Lierle, P.} (2023) \textit{Europa's Alkali Exosphere During the 2022 Juno Flyby}, American Geophysical Union, Fall Meeting 2023.
   ...
   \item de Kleer, K., Milby, M., Schmidt, C., Camarca, M., Brown, M. (2023) \textit{The Optical Aurorae of Europa, Ganymede, and Callisto}, American Geophysical Union, Fall Meeting 2023.
   \item Morgenthaler J., Schmidt, C., Vogt, M., Schneider, N. (2023) Io plasma torus observations on 550 nights during the Juno era: A comprehensive record of the modulation in the flow of plasma into and out of Jupiter's magnetosphere, American Geophysical Union, Fall Meeting 2023.
   \item Nerney, E., Bagenal, F., Wilson, R. J., Schmidt, C. (2023) A 3D Model of the Io Plasma torus and Model Comparisons with Observations, American Geophysical Union, Fall Meeting 2023.
   ...
   %\item Milby, Z. de Kleer, K., Schmidt, C. (2023) \textit{Ganymede something or other}, EPSC-DPS Joint Meeting, held 1-6 October in San Antonio, Texas.	
...
\begin{itemize} \itemsep -2pt % reduce space between items
  ...
  \item Session Chair: AGU: Dynamics of the Io-Jupiter System (2014) and Dynamic Exospheres of Terrestrial bodies through the Solar System (2023), Io plasma torus splinter meetings at MOP (2017 \& 2018), Exosphere/Magnetosphere, Mercury: Current and Future Science of the Innermost Planet, USRA (2018)
...
\rule{\textwidth}{1pt}
\noindent Astronomy Magazine: {\it Aurorae throughout our solar system and beyond} \hfill 2023\\
