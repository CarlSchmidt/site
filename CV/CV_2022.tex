...
\begin{itemize} \itemsep -2pt % reduce space between item
  ...
  \item J. P. Morgenthaler, C. A. Schmidt, N. M. Schneider, M. Marconi and M. F. Vogt (2023) \textit{Fall 2022: Largest gas-rich Io volcanic outburst observed in Juno era}. Astrophysical Journal Letters, \textit{under review}
 \end{itemize}
%------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
\vspace{2 mm}
...
\rule{\textwidth}{1pt}
\begin{itemize} \itemsep -2pt % reduce space between item
  \item K. de Kleer, Z. Milby, C. Schmidt, M. Camarca and M. Brown (2023) \textit{The Optical and Near-Infrared Aurorae of Europa, Ganymede and Callisto}. The Planetary Science Journal, \textit{in press}
