...
\begin{itemize} \itemsep -2pt % reduce space between item
  \item D. Bhattacharyya, J. T. Clarke, M. Mayyasi, V. Shematovich, D. Bisikalo, J. Y. Chaufray, E. Thiemann, J. Halekas, C. Schmidt, J.L. Bertaux, M. S. Chaffin, and N. M. Schneider (2023) \textit{Evidence of Hot Hydrogen in the Exosphere of Mars Resulting in Enhanced Water Loss}. Nature Astronomy, \textit{under review}
  ...
  \item K. de Kleer, Z. Milby, C. Schmidt, M. Camarca and M. Brown (2023) \textit{The Optical and Near-Infrared Aurorae of Europa, Ganymede and Callisto}. The Planetary Science Journal, \textit{under review}
 \end{itemize}
\vspace{2 mm}
...
\rule{\textwidth}{1pt}
\begin{itemize} \itemsep -2pt % reduce space between item
  \item C. Schmidt, \underline{M. Sharov}, K. de Kleer, N. Schneider, I. de Pater, P.H. Phipps, A. Conrad, L. Moore, P. Withers, J. Spencer, J. Morgenthaler, I. Ilyin, K. Strassmeier, C. Veillet, J. Hill, and M. Brown (2023) \textit{Io’s Optical Aurorae in Jupiter’s Shadow}. The Planetary Science Journal, \textit{in press.}
