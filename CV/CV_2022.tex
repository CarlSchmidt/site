...
\begin{itemize} \itemsep -2pt % reduce space between item
  ...
  \item C. Schmidt (2022) \textit{Doppler-Shifted Alkali D Absorption as Indirect Evidence for Exomoons}. Frontiers in Astronomy and Space Sciences, under review.
 \end{itemize}
\vspace{2 mm}
...
\rule{\textwidth}{1pt}
\noindent The Io-Jupiter Interaction, UMD, College Park, MD, USA \hfill 2015\\
