...
%\begin{itemize} \itemsep -2pt
%	\item Rozenn Robidel (PhD expected 2023, Université de Versailles Saint-Quentin-en-Yvelines) %LATMOS Laboratoire Atmosphères, Milieux, Observations Spatiales
%\end{itemize}
