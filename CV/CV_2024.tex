...
% \item L. Roth an 16 co-authors including C. Schmidt (2024) \textit{The supply of mass from Io to Jupiter's magnetosphere: What causes transient changes in the neutral and plasma environment?}, Space Science Reviews, \textit{under review}
...
%  \item A. V. Oza, J. V. Seidel, A. Gebek, A. Kesseli, H. J. Hoeijmakers, C. A. Schmidt, M. Meyer zu Westram, U. Athira, S. Torres, T. Sivarani, I. Bhatnagar, C. Fisher, S. Charnoz, A.D. Baker, S.P. Halverson, K. de Kleer, R. Hu, R. Lopes, N. Schneider, R. E. Johnson and A. Wyttenbach (2024) \textit{Sodium Haze Orbiting Near the Tidal Disintegration Limit of a Rocky Exomoon: Time-Series Na D2 and Doppler Shifts Identified at the Exo-Io Candidate WASP-49 b}. Monthly Notices of the Royal Astronomical Society, \textit{under review}
