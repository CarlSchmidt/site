...
\rule{\textwidth}{1pt}
\begin{itemize} \itemsep -2pt % reduce space between item
  \item C. Gray, K. Peter, M. P\"atzold, S. Tellmann, T. Nordheim, \textbf{C. Schmidt}, N Chanover and P. Withers (2024) \textit{Venus' O 5577{\AA} Oxygen Green Line: A Global Diffuse Proton-induced Aurora}. Journal of Geophysical Research: Space Physics, \textit{in press.}
