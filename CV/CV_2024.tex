...
\begin{itemize} \itemsep -2pt % reduce space between item
  ...
  \item M. Yoneda, F. Tsuchiya, \textbf{C. Schmidt}, M. Kagitani and T. Sakanoi (2024) \textit{Major Brightening Events in Jupiter's Sodium Nebula during Juno era}. Icarus, \textit{under review}
...
\rule{\textwidth}{1pt}
\begin{itemize} \itemsep -2pt % reduce space between item
  \item Z. Milby, K. de Kleer, \textbf{C. Schmidt}, and F. Leblanc (2024) \textit{Short-Timescale Spatial Variability of Ganymede’s Optical Aurora}, Planetary Science Journal, \textit{in press}
